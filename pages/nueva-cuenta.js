      ...
      <Layout>
        <div className="container align-middle mt-3 min-height">
          <div className="row mx-1 justify-content-center ">
            <form
              className="card bg-app py-4 py-lg-0 py-xxl-4 col-12 col-lg-5 m-5vh"
            ...
            >
              ...
              <div className="form-floating mx-3 my-2 shadow">
                ...
                >
                  ...
                  {errorAuth ? "El correo ya esta registrado" : ""}
                </div>
              </div>
